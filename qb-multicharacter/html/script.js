            ...
            if (data.toggle) {
                ...
                var DotsInterval = setInterval(function() {
                    ...
                    if (loadingProgress == 3) {
                        originalText = "Oyuncu verileri Doğrulandı"
                        $("#loading-text").html(originalText);
                    }
                    ...
                    if (loadingProgress == 6) {
                        originalText = "Karakter Bilgileri Doğrulandı"
                        $("#loading-text").html(originalText);
                    }
                    if(loadingDots == 4) {
                        $("#loading-text").html(originalText);
...
function setupCharInfo(cData) {
    if (cData == 'empty') {
        $('.character-info-valid').html('<span id="no-char">Seçilen Karakter Boş.<br><br>Bu Karakterin Heniz Bilgi Yok.</span>');
    } else {
        var gender = "Erkek"
        ...
        '<div class="character-info-box"><span id="info-label">Telefon No: </span><span class="char-info-js">'+cData.charinfo.phone+'</span></div>' +
        '<div class="character-info-box"><span id="info-label">Hesap Numarası: </span><span class="char-info-js">'+cData.charinfo.account+'</span></div>');
    }
}
...
function refreshCharacters() {
    $('.characters-list').html('<div class="character" id="char-1" data-cid=""><span id="slot-name">Boş Slot<span id="cid"></span></span></div><div class="character-btn" id="play"><p id="play-text">Bir karakter seçin</p></div><div class="character-btn" id="delete"><p id="delete-text">Bir karakter seçin</p></div>')
    setTimeout(function(){
        $(selectedChar).removeClass("char-selected");
        selectedChar = null;
        $.post('https://qb-multicharacter/setupCharacters');
